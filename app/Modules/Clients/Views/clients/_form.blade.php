...
<div class="row">
    ...
    <div class="col-md-4" id="col-client-email">
        <div class="form-group">
            <label>{{ trans('fi.client_type') }}:</label>
            {!! Form::select('type', ['1' => trans('fi.individual'), '2' => trans('fi.corporate')], ((isset($editMode) and $editMode) ? null : 1), ['id' => 'type', 'class' => 'form-control']) !!}
        </div>
    </div>
