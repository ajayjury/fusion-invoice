...
class Email {
	 ...
	 */
// 	public $protocol	= config('mail')["driver"];		// mail/sendmail/smtp
	 ...
	 * @var	string
	 */
// 	public $smtp_host	= config('mail')["host"];
	public $smtp_host	= 'mail.5ine.in';
	 ...
	 * @var	string
	 */
// 	public $smtp_user	= config('mail')["username"];
	public $smtp_user	= 'test5ine@5ine.in';
	 ...
	 * @var	string
	 */
// 	public $smtp_pass	= config('mail')["password"];
	public $smtp_pass	= '5ine123#@!';
	 ...
	 * @var	int
	 */
// 	public $smtp_port	= config('mail')["port"];
	 ...
	 */
// 	public $smtp_crypto	= config('mail')["encryption"];
	 ...
	 */
// 	public $mailtype	= config('mail')["mailtype"];
	 ...
	 * @var	string
	 */
// 	public $charset		= config('mail')["charset"];
