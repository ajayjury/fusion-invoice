...
Route::group( [ 'prefix' => 'scheduler', 'middleware' => ['web', 'auth.admin'], 'namespace' => 'Addons\Scheduler\Controllers' ], function () {
	...
	Route::get('/colors', ['uses' => 'ColorCategoryController@index', 'as' => 'scheduler.colors.index']);
	Route::get('/colors/{id}/edit', ['uses' => 'ColorCategoryController@edit', 'as' => 'scheduler.colors.edit']);
	Route::put('/colors/{id}', ['uses' => 'ColorCategoryController@update', 'as' => 'scheduler.colors.update']);
	...
	Route::get( '/about', [
		function () {
			return view( 'Scheduler::schedule.about' );
		},
		'as' => 'scheduler.about'
	] );
