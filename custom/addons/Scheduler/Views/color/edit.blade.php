        ...
        <div class="col-md-8 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">{{ trans('Scheduler::texts.edit_colors') }}</h3>
                </div>
                <div class="panel-body">
                {!! Form::model($categories, array('route' => array('scheduler.colors.update', $categories->id),
                ...
                <!-- Name input-->
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            {!! Form::text('name',$categories->name,['id'=>'name', 'placeholder'=>'Category Name', 'class'=>'form-control', 'readonly'=>'true']) !!}
                        </div>
                    </div>
                    <!-- text_color input-->
